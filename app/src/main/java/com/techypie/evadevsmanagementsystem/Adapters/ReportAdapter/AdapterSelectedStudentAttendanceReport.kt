...
class AdapterSelectedStudentAttendanceReport(context : Context , studentList : MutableList<Student>): RecyclerView.Adapter<AdapterSelectedStudentAttendanceReport.ViewHolder>() {

    var context : Context
    var studentList = mutableListOf<Student>()
    var studentInterface : StudentInterfaceAttendance
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            studentInterface.onSelectedStudentAttendance(studentList[position])
        }
    }
    ...
    interface StudentInterfaceAttendance{
        fun onSelectedStudentAttendance(student: Student)
    }
