...
class AdapterChooseStudentForFee(context: Context, studentList : MutableList<Student>) : RecyclerView.Adapter<AdapterChooseStudentForFee.ViewHolder>() {
    ...
    init {
        ...
        studentInterface = context as ActivityAddFee
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterChooseStudentForFee.ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.adapter_choose_student, parent, false))
    }

    override fun onBindViewHolder(holder: AdapterChooseStudentForFee.ViewHolder, position: Int) {
