...
class AdapterStudent(context: Context , studentList : MutableList<Student>) : RecyclerView.Adapter<AdapterStudent.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            context.startActivity(Intent(context,ActivityUpdateStudent::class.java)
