...
class AdapterChooseCourse(context: Context , courseList : MutableList<Course>) : RecyclerView.Adapter<AdapterChooseCourse.ViewHolder>() {
    ...
    init {
        ...
        courseInterface = context as ActivityAddEnrollment
    }
